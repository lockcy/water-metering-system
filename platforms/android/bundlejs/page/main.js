...
var _wxcSwipeAction = __webpack_require__(227);
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\header4.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-48e3fff2"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = navigateToBack;
/**
 * 页面跳转路由
 */
var navigator = weex.requireModule('navigator');
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\add_subsite.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b1a070ae"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	beforeCreate: function beforeCreate() {
		...
		storage.setItem('uid', '5eb2e0d9e525c60008b75619', function (res) {
	...
	methods: {
		saveData: function saveData() {
			...
			stream.fetch({
				...
				if (res.status == 200) {
					_this2.qid = res.data.results[0].objectId;
					stream.fetch({
						method: 'POST',
						type: 'json',
						...
						headers: {
							...
							'X-LC-Id': 'Q4JYeS8N8yTAhdaFtzqW67KX-gzGzoHsz',
							'X-LC-Key': '2sQzz08lA6wd7OV2mLM6orHe' },
						body: '{"id":{"__type":"Pointer","className":"_User","objectId":"' + _this2.qid + '"},"name":"' + _this2.name + '","condition":"' + _this2.condition + '","place":"' + _this2.place + '"}'
					}, function (res) {
						if (res.status == 201) {
							toast("添加成功！");
						} else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "input": function($event) {
        _vm.place = $event.target.attr.value
      }
    }
  }), _c('input', {
    ...
    on: {
      "wxcButtonClicked": _vm.cancelData
    }
  })], 1)])])
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\header3.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-49002ef4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\datahis.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-131503e8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
				...
				storage.getItem('uid', function (res) {
						if (res.result == 'success') {
								...
								stream.fetch({
										method: 'GET',
										type: 'json',
										url: 'https://leancloud.cn:443/1.1/classes/subsite?where={"id": {"__type": "Pointer","className": "_User", "objectId": "' + _this.ssid + '"}}&limit=10',
										headers: {
												'X-LC-Id': 'Q4JYeS8N8yTAhdaFtzqW67KX-gzGzoHsz',
												'X-LC-Key': '2sQzz08lA6wd7OV2mLM6orHe'
										}
										...
										if (res.status == 200) {
												...
												_this.length = parseInt(res.data.results.length);
												_this.test2 = res.data.results;
												for (var i = 0; i < _this.length; i++) {
														_this.subsite1.push(res.data.results[i].name);
														_this.subsite_id.push(res.data.results[i].objectId);
														...
														for (var j = 0; j < res.data.results[i].equipment.length; j++) {
																_this.equ[i][j] = res.data.results[i].equipment[j];
														}
												}
										} else {
												toast(" 未知错误！");
		...
		methods: {
				pickDate1: function pickDate1() {
						...
						picker.pickDate({
								...
								if (event.result === 'success') {
										_this2.date_start = event.data;
								}
						});
				},
				pickDate2: function pickDate2() {
						var _this3 = this;
						...
						picker.pickDate({
								...
								if (event.result === 'success') {
										_this3.date_end = event.data;
								}
						});
				},
				pickTime1: function pickTime1() {
						var _this4 = this;
				...
				pick: function pick() {
						...
						picker.pick({
								...
								if (event.result === 'success') {
										_this6.index = event.data;
										_this6.subsite = _this6.subsite1[event.data];
										_this6.data_type = '请选择数据类型';
								}
						});
				},
				pickType: function pickType() {
						...
						picker.pick({
								...
								if (event.result === 'success') {
										_this7.data_type = _this7.equ[_this7.index][event.data];
								}
						});
				},
				go: function go() {
						(0, _router2.default)('graph');
				},
				queryData: function queryData() {
						...
						stream.fetch({
								...
								if (res.status == 200) {
										_this8.ttest = [];
										_this8.results = res.data.results;
										_this8.data_length = res.data.results.length;
										for (var i = 0; i < _this8.data_length; i++) {
												_this8.data_time[i] = _this8.results[i].date.iso;
												_this8.data_name[i] = _this8.results[i].dataname;
												_this8.data_data[i] = _this8.results[i].data;
												_this8.ttest.push({ id: i, name: _this8.data_time[i] + '    ' + _this8.data_name[i] + '    ' + _this8.data_data[i] });
										}
										if (_this8.data_length == 100) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["button_site"],
    on: {
      "click": _vm.pick
    }
  }, [_vm._v(_vm._s(_vm.subsite))]), _c('text', {
    staticClass: ["button_type"],
    on: {
      "click": _vm.pickType
    }
  }, [_vm._v(_vm._s(_vm.data_type))])]), _c('div', {
    staticClass: ["group"]
  }, [_c('text', {
  ...
  }, [_vm._v(_vm._s(_vm.date_start))]), _c('text', {
    staticClass: ["start-text"]
  }, [_vm._v("起始时间")]), _c('text', {
    staticClass: ["button"],
    on: {
  ...
  }, [_vm._v(_vm._s(_vm.time_start))])]), _c('div', {
    staticClass: ["group"]
  }, [_c('text', {
  ...
  }, [_vm._v(_vm._s(_vm.date_end))]), _c('text', {
    staticClass: ["end-text"]
  }, [_vm._v("结束时间")]), _c('text', {
    staticClass: ["button"],
    on: {
  ...
  }, [_vm._v(_vm._s(_vm.time_end))])]), _c('div', {
    staticClass: ["butt"],
    staticStyle: {
      flexDirection: "row"
    }
    ...
    on: {
      "wxcButtonClicked": _vm.queryData
    }
  }), _c('wxc-button', {
    staticClass: ["graph"],
    attrs: {
    ...
    on: {
      "wxcButtonClicked": _vm.go
    }
  })], 1)]), _c('scroller', {
    staticClass: ["scroller"]
  }, _vm._l((_vm.ttest), function(row) {
    return _c('div', {
      key: row.id,
      staticClass: ["row"]
    }, [_c('text', {
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\header.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\header2.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-491c5df6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\info.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b75c50c4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _global = __webpack_require__(252);
...
exports.default = {
	...
	created: function created() {
		...
		//     }
		// });
		storage.setItem('objectId', '5eb2e0d9e525c60008b75619', function (res) {
			if (res.result == 'success') {
				// 数据缓存成功
			}
		});
		storage.setItem('username', 'admin', function (res) {
			if (res.result == 'success') {
				// 数据缓存成功
			}
		});
		...
		//     }
		// });
		storage.getItem('username', function (res) {
			if (res.result == 'success') {}
		});
		storage.getItem('objectId', function (res) {
			if (res.result == 'success') {
				_this.ssid = res.data;
				stream.fetch({
					method: 'GET',
					type: 'json',
					url: 'https://leancloud.cn:443/1.1/classes/_User/' + _this.ssid,
					headers: {
						'X-LC-Id': 'Q4JYeS8N8yTAhdaFtzqW67KX-gzGzoHsz',
						'X-LC-Key': '2sQzz08lA6wd7OV2mLM6orHe' }
				}, function (res) {
					if (res.status == 200) {
						...
						_this.username_old = res.data.username;
						_this.phone = res.data.phone;
						_this.phone_old = res.data.phone;
						_this.email = res.data.email;
						_this.email_old = res.data.email;
					} else {
						//
						//toast("获取数据失败");
					}
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\login_log.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0a477ea4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
				...
				stream.fetch({
					...
					if (res.status == 200 && res.data.results != '') {
						...
						stream.fetch({
							method: 'GET',
							type: 'json',
							url: 'https://leancloud.cn:443/1.1/classes/login_log?where={"id": { "__type": "Pointer", "className": "_User", "objectId": "' + _this2.qid + '"}}',
							headers: {
								'X-LC-Id': 'Q4JYeS8N8yTAhdaFtzqW67KX-gzGzoHsz',
								'X-LC-Key': '2sQzz08lA6wd7OV2mLM6orHe',
							...
							if (res.status == 200) {
								_this2.test = res.data.results.length;
								_this2.length = parseInt(res.data.results.length);
								for (var i = 0; i < _this2.length; i++) {
									_this2.list_ip[i] = res.data.results[i].ip;
									_this2.list_time[i] = res.data.results[i].time.iso;
								}
							} else {
								toast(" 未知错误！");
							}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "input": function($event) {
        _vm.queryname = $event.target.attr.value
      }
    }
  }), _c('div', {
    staticClass: ["btn-holder"]
    ...
    staticClass: ["test"]
  }, [_c('list', _vm._l((this.length), function(index) {
    return _c('cell', {
      staticClass: ["cell"],
      appendAsTree: true,
      attrs: {
      ...
      staticClass: ["q"]
    }, [_vm._v(_vm._s(_vm.queryname))]), _c('text', {
      staticClass: ["q"]
    }, [_vm._v(_vm._s(_vm.list_ip[index - 1]))]), _c('text', {
      staticClass: ["q"]
    }, [_vm._v(_vm._s(_vm.list_time[index - 1]))])])
  }))])])
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\alarm.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-73f9c011"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	components: { WxcButton: _weexUi.WxcButton, WxcDialog: _weexUi.WxcDialog, 'title': _header2.default },
	data: function data() {
		return {
			show: false,
			isChecked: false,
			...
			stream.fetch({
				...
				if (res.status === 200) {
					...
					for (var i = 0; i < data_length; i++) {
						...
						_this5.results.push({ id: i, data: results[i].time.iso + '    ' + results[i].content + '    ' + results[i].operator + '    ' + results[i].solve + '    ' });
					}
				} else {
					toast('历史报警查询失败！');
				}
		...
		getLive: function getLive() {
			...
			stream.fetch({
				...
				if (res.status === 200) {
					...
					var data_length = res.data.results.length;
					for (var i = 0; i < data_length; i++) {
						_this6.results1.push({ id: i, data: results[i].time.iso + '    ' + results[i].content + '    ' + results[i].solve });
					}
				} else {
					toast('实时报警查询失败！');
				}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["text"]
    }, [_vm._v(_vm._s(row.data))])])
  })), _vm._m(1), _c('scroller', {
    staticClass: ["scroller-live"]
  }, _vm._l((_vm.results1), function(row) {
    return _c('div', {
      key: row.id,
      staticClass: ["row"]
    }, [_c('text', {
      staticClass: ["text"]
    }, [_vm._v(_vm._s(row.data))]), _c('wxc-button', {
      staticClass: ["solve"],
      attrs: {
        "text": "处理",
        "type": "red",
      ...
      on: {
        "wxcButtonClicked": _vm.openDialog
      }
    })], 1)
  }))]), _c('wxc-dialog', {
    attrs: {
  ...
  return _c('div', {
    staticClass: ["alarm-live"]
  }, [_c('text', {
    staticClass: ["title_history"]
  }, [_vm._v("历史报警")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["alarm-live"]
  }, [_c('text', {
    staticClass: ["title_live"]
  }, [_vm._v("实时报警")])])
}]}
module.exports.render._withStripped = true
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\datanow.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5aefd92c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
		components: { 'title': _header2.default, WxcButton: _weexUi.WxcButton },
		data: function data() {
				return {
						list: ['111', '222', '333'],
						subsite: [],
				...
				storage.getItem('uid', function (res) {
						if (res.result == 'success') {
								...
								stream.fetch({
										method: 'GET',
										type: 'json',
										url: 'https://leancloud.cn:443/1.1/classes/subsite?where={"id":{"__type": "Pointer","className": "_User","objectId": "' + _this.ssid + '"}}&&limit=20',
										headers: {
										...
										if (res.status == 200) {
												...
												for (var i = 0; i < number; i++) {
														...
														_this.subsite.push(res.data.results[i].name);
												...
												stream.fetch({
														method: 'GET',
														type: 'json',
														url: 'https://leancloud.cn:443/1.1/classes/equipment?where={"sid":{"__type": "Pointer", "className": "subsite", "objectId":"' + _this.subsite_id[0] + '"}}',
														headers: {
																'X-Avoscloud-Application-Id': 'Q4JYeS8N8yTAhdaFtzqW67KX-gzGzoHsz',
																'X-Avoscloud-Application-Key': '2sQzz08lA6wd7OV2mLM6orHe' }
												}, function (res) {
				...
				pick: function pick() {
						...
						picker.pick({
								...
								if (event.result === 'success') {
										...
										_this2.subsite_select = _this2.subsite[event.data];
								}
						});
				},
				getData: function getData() {
						...
						stream.fetch({
								...
								if (res.status == 200) {
										...
										_this3.temp = _this3.subsite_id;
										_this3.test1 = _this3.temp;
								} else {
										toast("获取数据失败");
								}
						});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcButtonClicked": _vm.pick
    }
  }), _c('text', {
    staticClass: ["subsite-text"]
  }, [_vm._v(_vm._s(_vm.subsite_select))])], 1), _c('scroller', {
    staticClass: ["main"]
  }, [_c('div', {
    staticClass: ["flex-test"]
    ...
    }, [_vm._v(_vm._s(data.name))]), (data.unit) ? _c('text', {
      staticStyle: {
        marginTop: "20px",
        marginBottom: "20px",
        fontSize: "20px"
      }
    }, [_vm._v("(" + _vm._s(data.unit) + ")")]) : _vm._e()]), _c('text', {
      staticStyle: {
        marginTop: "20px",
        marginBottom: "20px",
        fontSize: "20px"
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\equipment.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0cbc30ce"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	components: { WxcEpSlider: _weexUi.WxcEpSlider, WxcButton: _weexUi.WxcButton, WxcMask: _weexUi.WxcMask, WxcDialog: _weexUi.WxcDialog, 'title': _header2.default },
	data: function data() {
		return {
			sliderId: 1,
		...
		storage.getItem('uid', function (res) {
			if (res.result == 'success') {
				...
				stream.fetch({
					...
					if (res.status == 200) {
						_this.number = parseInt(Object.keys(res.data.results).length);
						_this.eqnumber = parseInt(res.data.results[0].equipment.length);
						for (var j = 0; j < _this.number; j++) {
							_this.subsite.push(res.data.results[j].name);
							_this.subsite_id.push(res.data.results[j].objectId);
							//
						}
						_this.getData();
					} else {
	...
	methods: {
		...
		getData: function getData() {
			...
			stream.fetch({
				...
				if (res.status == 200) {
					...
					for (var i = 0; i < number; i++) {
						_this2.index[i] = i;
						_this2.list.push(res.data.results[i].name);
						_this2.list1.push(res.data.results[i].place);
						_this2.list2.push(res.data.results[i].condition);
						_this2.list3.push(res.data.results[i].data);
						_this2.list4.push(res.data.results[i].objectId);
						_this2.url.push(res.data.results[i].pic.url);
					}
				} else {
					toast("获取数据失败");
				}
		...
		delData: function delData() {
			...
			stream.fetch({
				...
				if (res.status == 200) {
					_this3.list.splice(_this3.indexg, 1);
					_this3.list1.splice(_this3.indexg, 1);
					_this3.list2.splice(_this3.indexg, 1);
					_this3.list3.splice(_this3.indexg, 1);
					_this3.list4.splice(_this3.indexg, 1);
					toast("删除数据成功");
				} else {
					toast("删除数据失败");
				}
		...
		pick: function pick() {
			...
			picker.pick({
				...
				if (event.result === 'success') {
					_this4.indexsub = event.data;
					_this4.subsite_select = _this4.subsite[event.data];
					_this4.clear();
					_this4.getData();
				}
			});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, _vm._l((this.index), function(v, index) {
    return _c('div', {
      key: index,
  ...
  }, [_vm._v("设备名称:  " + _vm._s(_vm.list[_vm.indexg]))]), _c('text', {
    staticClass: ["equipment-place"]
  }, [_vm._v("设备地点:  " + _vm._s(_vm.list1[_vm.indexg]))]), _c('text', {
    staticClass: ["equipment-condition"]
  }, [_vm._v("运行状态:  " + _vm._s(_vm.list2[_vm.indexg]))]), _c('text', {
    staticClass: ["equipment-data"]
  }, [_vm._v("数据:  " + _vm._s(_vm.list3[_vm.indexg]))])]), _c('div', {
    staticClass: ["select"]
  }, [_c('wxc-button', {
    staticClass: ["select_1"],
    attrs: {
      "text": "子站选择",
      "type": "blue",
      "size": "medium"
    ...
    staticClass: ["select_2"]
  }, [_vm._v("当前子站" + _vm._s(_vm.subsite_select))])], 1), _c('wxc-dialog', {
    attrs: {
      "title": "警告",
      "content": "是否删除",
      "show": _vm.show,
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\home.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.default = {
	...
	methods: {
		...
		exit: function exit() {
			storage.removeItem('ssid', function (res) {
				if (res.result == 'success') {
					//清除缓存数据后的操作
					//navigateTo("login");
				}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["avatar"],
    attrs: {
      "src": "http://47.101.196.184/final/timg.jpg"
    }
  }), _c('div', {
    staticClass: ["username"]
  }, [_c('text', {
    ...
    on: {
      "wxcButtonClicked": _vm.handleSubmit
    }
  }), _c('wxc-button', {
    staticClass: ["login"],
    attrs: {
    ...
    staticClass: ["test"]
  }, [_c('text', [_vm._v(_vm._s(_vm.test))])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\subsites.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3e057bbc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	components: { WxcTabPage: _weexUi.WxcTabPage, WxcPanItem: _weexUi.WxcPanItem, 'title': _header2.default },
	data: function data() {
		return {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["t"],
    attrs: {
      "src": "http://47.101.196.184/final/11.png"
    }
  })])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\components\\testna.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4a51e196"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _info = __webpack_require__(279);

var _info2 = _interopRequireDefault(_info);

var _add_subsite = __webpack_require__(255);

var _add_subsite2 = _interopRequireDefault(_add_subsite);

var _login_log = __webpack_require__(283);

var _login_log2 = _interopRequireDefault(_login_log);

var _datahis = __webpack_require__(263);

var _datahis2 = _interopRequireDefault(_datahis);
...
exports.default = {
  components: { WxcTabPage: _weexUi.WxcTabPage, WxcPanItem: _weexUi.WxcPanItem, 'title': _header2.default, 'info': _info2.default, 'subsite': _add_subsite2.default, 'log': _login_log2.default, 'datahis': _datahis2.default },
  data: function data() {
    return {
      tabTitles: _config2.default.tabTitles_home,
      tabStyles: _config2.default.tabStyles_home,
      tabList: [],
      demoList: [1],
      tabPageHeight: 1334,
      current_index: 1,
  ...
  return _c('div', {
    ...
    return _c('list', {
      ...
      return _c('cell', {
        ...
        staticClass: ["content"]
      }, [(_vm.current_index == 1) ? _c('div', [_c('info')], 1) : _vm._e(), (_vm.current_index == 2) ? _c('div', [_c('subsite')], 1) : _vm._e(), (_vm.current_index == 3) ? _c('div', [_c('log')], 1) : _vm._e(), (_vm.current_index == 4) ? _c('div', [_c('datahis')], 1) : _vm._e()])])], 1)
    })], 2)
  }))], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\page\\main.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
var _alarm = __webpack_require__(287);

var _alarm2 = _interopRequireDefault(_alarm);

var _datanow = __webpack_require__(291);

var _datanow2 = _interopRequireDefault(_datanow);

var _equipment = __webpack_require__(295);

var _equipment2 = _interopRequireDefault(_equipment);

var _subsites = __webpack_require__(303);

var _subsites2 = _interopRequireDefault(_subsites);

var _home = __webpack_require__(299);

var _home2 = _interopRequireDefault(_home);

var _testna = __webpack_require__(307);

var _testna2 = _interopRequireDefault(_testna);
...
exports.default = {
	components: { WxcTabBar: _weexUi.WxcTabBar,
		...
		'equipment': _equipment2.default,
		'datanow': _datanow2.default,
		'subsites': _subsites2.default,
		'home': _home2.default,
		'testna': _testna2.default },
	data: function data() {
		return {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('equipment'), _c('datanow'), _c('subsites'), _c('alarm'), _c('testna')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
