...
__vue_options__.__file = "D:\\weex\\water-metering-system\\src\\page\\register.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5ca225ba"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _router3 = __webpack_require__(253);
		...
		registerSubmit: function registerSubmit() {
			...
			if (this.username == '' || this.password == '' || this.email == '' || this.phone == '' || this.re_password == '') {
				...
				stream.fetch({
					...
					if (res.status == 201) {
						toast('注册成功');
						storage.setItem('objectId', res.data.objectId, function (res) {
							if (res.result == 'success') {
								storage.setItem('username', res.data.username, function (res) {
									if (res.result == 'success') {
										(0, _router4.default)();
									}
								});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["re-password-modal"]
  }, [_c('input', {
    staticClass: ["re-password-input"],
    attrs: {
      "type": "password",
      "autoComplete": "off",
      "placeholder": "请确认密码",
    ...
    on: {
      "input": function($event) {
        _vm.re_password = $event.target.attr.value
      }
    }
  })]), _c('div', {
    ...
    on: {
      "wxcButtonClicked": _vm.registerSubmit
    }
  }), _c('wxc-button', {
    staticClass: ["exit"],
    attrs: {
